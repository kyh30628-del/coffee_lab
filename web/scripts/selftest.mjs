...
// ── 백화점/몰 입점 카페: 접미사 없는 타지점 리뷰(decisions#1028, rulegap-proposals-20260908-3)
//   기존 '○○점' 접미사 판별은 브랜드명이 전국 공통이고 리뷰가 '지역명+다른 유통사 브랜드'만으로
//   타지점을 서술하는 백화점/몰 입점 카페를 못 잡았다(id25512 슈퍼말차 스타필드 수원 ← 인천 롯데백화점
//   리뷰, id14728 아틀리에폰드 갤러리아백화점 ← 잠실 롯데월드몰 리뷰 실측).
{
  const r1 = verifyReview({
    name: "슈퍼말차 스타필드 수원", title: "수원 스타필드 슈퍼말차 후기",
    body: "인천 롯데백화점 카페 슈퍼말차 블랙 롤케이크 아이스크림 라떼 다녀왔어요 정말 맛있었습니다",
    areaTerms: ["수원시", "권선구"], source: "blog",
  });
  T("id25512형: 인천 롯데백화점(자기 계열=신세계 아님) 타지점 거절", r1.verdict === "rejected");
  const r2 = verifyReview({
    name: "아틀리에폰드 갤러리아백화점 명품관 EAST점", title: "아틀리에폰드 다녀온 후기",
    body: "잠실 실내 데이트 롯데월드몰 맛집 베이커리 카페 아틀리에폰드 케이크 먹었어요 분위기 좋았습니다",
    areaTerms: ["강남구", "압구정동"], source: "blog",
  });
  T("id14728형: 잠실 롯데월드몰(자기 계열=갤러리아 아님) 타지점 거절", r2.verdict === "rejected");
  // ⚠️ 오탐 방지 핵심(제안서 경고): 같은 계열사의 다른 채널명(롯데백화점잠실점≈롯데월드몰)은 실제
  //   같은 복합단지일 수 있어 정당한 자기 언급이다 — 다른 유통사 지점 규칙으로 거절하면 안 됨.
  const r3 = verifyReview({
    name: "테스트카페 롯데월드몰점", title: "롯데월드몰 테스트카페 후기",
    body: "롯데백화점 잠실점 근처 롯데월드몰 테스트카페 다녀왔어요 케이크 맛있었습니다 분위기도 좋고 직원분도 친절했어요",
    areaTerms: ["송파구", "잠실동"], source: "blog",
  });
  T("같은 계열(롯데) 별칭은 오탐 아님(다른 유통사 지점 사유로 거절 안 됨)", !r3.reasons.some((r) => r.includes("다른 유통사 지점")));
  // 본 지점 방문 후기(자기 지역 언급, 타 유통사 브랜드 없음)는 그대로 통과 — 스코프가 좁아 일반 카페엔 무영향.
  const r4 = verifyReview({
    name: "슈퍼말차 스타필드 수원", title: "수원 스타필드 슈퍼말차 후기",
    body: "수원 스타필드 슈퍼말차 블랙 롤케이크 아이스크림 라떼 다녀왔어요 정말 맛있었습니다 분위기도 좋아요",
    areaTerms: ["수원시", "권선구"], source: "blog",
  });
  T("본 지점 방문 후기는 통과(오탐 방지)", r4.verdict !== "rejected");
}
