...
const FILES = ["fixtures-ads", "fixtures-vendor", "fixtures-foreign-region", "fixtures-branch", "fixtures-selfsource", "fixtures-ighandle", "fixtures-cafeidentity", "fixtures-cautions", "fixtures-coherence", "fixtures-area", "fixtures-rulesfp", "test-region-fixtures"];
