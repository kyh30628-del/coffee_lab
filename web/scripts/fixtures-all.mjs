...
const FILES = ["fixtures-ads", "fixtures-vendor", "fixtures-foreign-region", "fixtures-branch", "fixtures-cautions", "fixtures-coherence", "fixtures-area", "fixtures-rulesfp", "test-region-fixtures"];
