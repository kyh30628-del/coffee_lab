...
- ★지점·위치 구분(이름에 '점'이 없어도 적용): 대상 카페에는 위치(지역/동)가 괄호로 주어진다. 본문이 '그 위치'가 아니라 명백히 다른 동·역·구·지역을 주로 가리키면, 같은 브랜드·같은 상호라도 about=false. 예1) 대상이 '하츠베이커리 (송파구 가락동)'인데 본문이 '성수점'·성수/성동구를 다루면 false. 예2) 대상이 '펠어커피초코 갈매점'인데 본문이 '마곡점'·마곡/강서면 false. 대상이 '○○점'이면 그 지점·지역이 본문에 나와야 about=true이고, 지점·지역이 전혀 안 나오고 브랜드명만 있으면 about=false(어느 지점인지 특정 불가).
