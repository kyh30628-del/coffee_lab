    ...
    <main style={{ minHeight: "100vh", background: "#efe7d8", color: "#2b2018", fontFamily: "'Gowun Batang',serif", padding: "12px", maxWidth: 640, margin: "0 auto", paddingTop: "calc(12px + env(safe-area-inset-top))" }}>
      ...
      <div style={{ background: "#2b2018", color: "#e8b87a", borderRadius: 14, padding: "14px 16px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div style={{ display: "flex", gap: 7, flexWrap: "wrap", justifyContent: "flex-end" }}>
          <a href="/admin/criteria" style={{ background: "#c98a3c", color: "#fff", borderRadius: 9, padding: "8px 16px", fontSize: 12, fontWeight: 700, textDecoration: "none", minWidth: 84, textAlign: "center", whiteSpace: "nowrap" }}>기준</a>
          <a href="/admin/lounge" style={{ background: "#6a468c", color: "#fff", borderRadius: 9, padding: "8px 16px", fontSize: 12, fontWeight: 700, textDecoration: "none", minWidth: 84, textAlign: "center", whiteSpace: "nowrap" }}>라운지</a>
