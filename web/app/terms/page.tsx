        ...
        <div className="space-y-7 text-[14px] leading-relaxed text-[#3d2f22]">
          ...
          <section>
            ...
            <ul className="list-disc ml-5 space-y-1">
              ...
              <li>업로드 <b>사진·영상에 포함된 음원·배경음악·타인 저작물·인물(초상권) 등의 권리 처리 책임은 사장님</b>에게 있습니다. 사장님이 올린 사진·한마디는 '사장님 제공'으로 표시되며 검증 후기·등급과 분리됩니다. 분쟁 발생 시 해당 콘텐츠는 즉시 비공개될 수 있습니다.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc ml-5 space-y-1">
              ...
              <li><b>권리침해 신고·즉시 조치</b>: 본인 매장이 도용되었거나 권리가 침해된 경우 <b>dongnecoffeenote@gmail.com</b>으로 신고할 수 있으며, 본 서비스는 확인 즉시 해당 계정의 <b>노출 중지·이용 정지·자료 비공개</b> 등 필요한 조치를 취합니다.</li>
          ...
          <section>
            ...
            <p>dongnecoffeenote@gmail.com</p>
          </section>
        </div>
      </div>
