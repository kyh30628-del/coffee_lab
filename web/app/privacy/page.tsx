      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <div className="space-y-7 text-[14px] leading-relaxed text-[#3d2f22]">
          ...
          <section>
            ...
            <p>본 서비스는 <b>YouTube API Services</b>를 사용합니다. 이용으로써 사용자는 <a className="text-[#7a5122] underline" href="https://www.youtube.com/t/terms" target="_blank" rel="noopener noreferrer">YouTube 이용약관</a>에 동의하는 것으로 간주됩니다.</p>
            <ul className="list-disc ml-5 mt-2 space-y-1">
              ...
              <li>본 서비스는 <a className="text-[#7a5122] underline" href="https://developers.google.com/youtube/terms/api-services-terms-of-service" target="_blank" rel="noopener noreferrer">YouTube API Services 약관</a> 및 <a className="text-[#7a5122] underline" href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">Google 개인정보처리방침</a>을 준수합니다.</li>
            </ul>
          </section>
