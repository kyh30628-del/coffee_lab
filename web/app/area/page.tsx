...
export const metadata: Metadata = {
  ...
  description: "전국 동네별로 실제 방문 후기로 검증한 카페를 찾아보세요. 서울·경기·인천·강원·충청·부산·경남·대구·경북·광주·전남·전북·울산·제주. 작업·조용·디저트·스페셜티·분위기 취향별 추천.",
  alternates: { canonical: `${SITE}/area` },
  openGraph: { title: "동네별 카페 추천 — 동네 커피 노트", description: "전국 동네별 검증 카페. 취향별 추천.", url: `${SITE}/area`, siteName: "동네 커피 노트", type: "website", locale: "ko_KR" },
};
  ...
  return (
    <main className="min-h-screen bg-[#f4ece0] text-[#2b2018]" style={{ fontFamily: "'DCN Hand', 'Nanum Pen Script', 'Apple SD Gothic Neo', sans-serif" }}>
      <div className="max-w-2xl mx-auto px-5 py-10">
        ...
        <p className="text-[14px] text-[#524234] leading-relaxed mb-6">전국 동네별로 <b>영수증 리뷰·광고 없이 실제 방문 후기로 검증</b>한 카페를 모았어요. 서울·경기부터 부산·광주·전남·제주까지. 취향별로도 골라보세요.</p>
