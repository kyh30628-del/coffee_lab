      ...
      <div className="max-w-2xl mx-auto px-5 py-10">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc ml-5 space-y-1.5 text-[13px] text-[#52402e]">
            ...
            <li><b>환불 방법·기한</b>: 원결제수단 취소를 원칙으로 하며, 환급 사유 발생일(반환·해지 확인일)로부터 <b>3영업일 이내</b> 처리합니다. 정당한 사유 없이 지연하면 그 지연기간에 대해 <b>법정 지연배상금(연 15%)</b>을 더해 지급합니다. 신청·문의: <b>kyh30628@gmail.com</b>.</li>
