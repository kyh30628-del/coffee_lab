      ...
      <div className="max-w-2xl mx-auto px-5 py-10">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc ml-5 space-y-1.5 text-[13px] text-[#52402e]">
            ...
            <li><b>제한 및 표시 의무 이행</b>: 디지털 서비스 특성상 <b>홍보팩 기능(우선노출·쇼케이스 게시 등)을 이미 사용·개시</b>한 부분은 청약철회가 제한될 수 있습니다(「전자상거래법」 제17조 제2항). 본 서비스는 이 제한 사실을 명확히 표시하고, 철회권 행사가 방해되지 않도록 <b>7일 무료 체험(시험 사용)</b>을 제공합니다(같은 조 제6항). 개시되지 않은 부분에 대해서는 <b>잔여기간 일할 계산 환불</b>을 적용합니다.</li>
