      ...
      <div className="max-w-2xl mx-auto px-5 py-10">
          ...
          <table className="w-full text-[13px] border border-[#e6dcc8] rounded-lg overflow-hidden">
            <tbody>
              {[
                ...
                ["통신판매업 신고번호", FILL],
                ["사업장 주소", FILL],
                ["고객센터 이메일", "dongnecoffeenote@gmail.com"],
                ["고객센터 전화", FILL],
                ["호스팅 제공자", "Vercel Inc."],
                ["결제대행(PG)", FILL],
              ].map(([k, v]) => (
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc ml-5 space-y-1.5 text-[13px] text-[#52402e]">
            <li><b>{TRIAL_DAYS}일 무료 체험</b>: 결제 없이 {TRIAL_DAYS}일간 사장님 기능 이용. 체험은 <b>무료이므로 환불 대상이 아닙니다</b>. 체험 종료 시 자동으로 접근이 만료됩니다.</li>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc ml-5 space-y-1.5 text-[13px] text-[#52402e]">
            ...
            <li><b>제한 및 표시 의무 이행</b>: 디지털 서비스 특성상 <b>홍보팩 기능(우선노출·쇼케이스 게시 등)을 이미 사용·개시</b>한 부분은 청약철회가 제한될 수 있습니다(「전자상거래법」 제17조 제2항). 본 서비스는 이 제한 사실을 명확히 표시하고, 철회권 행사가 방해되지 않도록 <b>{TRIAL_DAYS}일 무료 체험(시험 사용)</b>을 제공합니다(같은 조 제6항). 개시되지 않은 부분에 대해서는 <b>잔여기간 일할 계산 환불</b>을 적용합니다.</li>
            <li><b>일할 환불 예</b>: 월 구독 중도 해지 시 = 결제금액 × (잔여일수 ÷ 결제주기 일수). <b>위약금은 부과하지 않습니다.</b></li>
            <li><b>본 서비스 귀책</b>(장애·오류 등)으로 정상 이용이 불가했던 경우 해당 기간은 전액 환불 또는 기간 연장으로 보상합니다.</li>
            <li><b>환불 방법·기한</b>: 원결제수단 취소를 원칙으로 하며, 환급 사유 발생일(반환·해지 확인일)로부터 <b>3영업일 이내</b> 처리합니다. 정당한 사유 없이 지연하면 그 지연기간에 대해 <b>법정 지연배상금(연 15%)</b>을 더해 지급합니다. 신청·문의: <b>dongnecoffeenote@gmail.com</b>.</li>
