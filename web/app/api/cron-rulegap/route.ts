...
// ⚠️ 2026-08-29 추가: 과자점·제과점.
//   지점명이 아니라 **업종 명사**인데 '○○점' 패턴에 걸려 매일 승인대기로 올라왔다(과자점 6곳·제과점 5곳).
//   실제 후기 확인 — "나폴레옹과자점 잠실점"(카페 자기 이름)·"HK노엘제과점"(자기 이름)·"프랑스식 제과점"(업종어).
//   지점어로 적용하면 **그 카페 자기 후기를 배제**한다(이 목록 아래 주석이 경고하는 '오적용 시 정상 후기 배제').
//   진짜 지점명은 위치로 붙는다(잠실점·강남점)—업종어를 빼도 감도 손실 없음.
const NON_BRANCH = /(백화점|면세점|서점|문고점|전문점|체인점|할인점|편의점|음식점|분식점|노점|상점|과자점|제과점|약국점|마트점|장점|단점|시점|관점|초점|약점|강점|정점|요점|중점|종점|만점|채점|별점|평점|빵점|매점|거점|기점|이점|반점|문제점|차이점|공통점|장단점|정기점|가맹점|직영점|무인점|판매점|득점|실점|승점|벌점|가점|감점|배점)$/;
