...
// 인천 2026-07-01 2군9구 개편(중구·동구→제물포구/영종구, 서구→검단구/서해구, 공식 확인) 반영 —
// 옛 중구·동구·서구는 폐지돼 목록에서 제거(소속 카페 263곳도 법정동 기준으로 실제 재분류 완료).
const INCHEON_GU = ["미추홀구", "연수구", "남동구", "부평구", "계양구", "강화군", "옹진군", "검단구", "서해구", "영종구", "제물포구"];
