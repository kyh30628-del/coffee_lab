...
export const LIST_META: ListMeta[] = [
  ...
  { key: "identity.weak_token", category: "정체성", label: "약한 식별토큰(유일·다중토큰 매칭 기여 시 엄격 매칭 요구)", consumer: "reviewQuality",
    items: ["공간", "다이아", "블라블라", "충무", "브라더스", "2005", "인테리어", "조도", "회전목마", "실험실", "청하동길", "스위치", "에스엠", "우리동네구멍가게", "오븐", "꿈꾸는", "우주", "사이", "톤앤매너", "좋은친구들", "시너지", "프렌즈", "향기로운", "온전한", "스토리", "우상향", "향초", "워크샵", "작업실", "하우스", "포레스트", "크리스탈", "허니브라운", "소문난", "플랫폼"] },
