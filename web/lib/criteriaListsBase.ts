...
{ key: "search.out_of_coverage", category: "검색개념", label: "검색: 미서비스 지역 키워드", consumer: "search.route",
    // 2026-09-06 부산·경남 편입 — 부산·경남 도시들(창원·진주·통영·김해·거제·양산·밀양) 제거. "경상"→"경상북도"로 세분(경남 오차단 방지).
    // 🔴 2026-09-12 대구·경북 편입 — "대구"·"경북"·"경상북도"·"포항"·"경주"·"안동"·"구미" 제거.
    //   제거 전까지 1,432곳을 공개해 놓고도 "대구 카페" 검색에 "아직 포함되어 있지 않아요"가 떴다(소비자 화면 실손상).
    //   ⚠️ 지역을 열면 이 목록·lib/serviceScope.ts·lib/regionList.ts 세 곳을 **같이** 고쳐야 한다(scripts/qa/region-scope-fixture.mjs가 강제).
    // 🆕 2026-09-17 전국 개방(CEO "전부 다") — 광주·전남·전북·울산·제주 편입으로 **목록을 비운다.**
    //   이제 미서비스 시·도가 없다. 여기 뭔가 남아 있으면 이미 공개한 지역에 "아직 포함 안 됐어요"가 뜬다
    //   (09-12에 대구 1,432곳을 공개해 놓고 그 안내가 떴던 실손상).
    items: [] },
