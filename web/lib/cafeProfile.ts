...
const HIGHLIGHTS: { label: string; emoji: string; kws: string[] }[] = [
  // ⚠️ 뷰 계열은 '실제로 뷰/물/자연이 보인다'는 맥락만 — 역·공원·지명 이름(장자호수공원역 등)에 든
  //   '호수·강·정원' 같은 단어가 뷰로 오인되지 않게 엄격히(뷰/보이/전망/멍 동반 요구).
  { label: "통창·창밖 뷰", emoji: "🪟", kws: ["통창", "큰 창", "창밖 뷰", "창밖 풍경", "뷰맛집", "뷰가 좋", "뷰가 예", "뷰가 멋", "전망이 좋", "뷰 보면서", "뷰 보며"] },
  { label: "루프탑·테라스", emoji: "🌿", kws: ["루프탑", "옥상", "테라스"] },
  { label: "정원·자연 뷰", emoji: "🌳", kws: ["정원이", "정원 뷰", "앞마당", "뒷마당", "가든뷰", "숲뷰", "숲세권", "숲속", "산뷰", "산이 보이", "자연 속", "초록빛", "나무가 보이"] },
  { label: "강·바다 뷰", emoji: "🌊", kws: ["한강뷰", "한강이 보", "한강 보이", "강뷰", "강이 보이", "오션뷰", "바다가 보", "바다뷰", "바다 전망", "리버뷰", "호수뷰", "호수가 보", "물멍", "워터프론트"] },
  { label: "넓고 탁 트인 공간", emoji: "🏛️", kws: ["넓은 공간", "넓고 쾌적", "공간이 넓", "대형 카페", "대형카페", "탁 트", "층고가", "층고 높", "웅장", "규모가 크"] },
