...
const GENERIC_WORD = new Set(["카페", "까페", "캬페", "카패", "까패", "커피", "커피숍", "커피샵", "coffeeshop", "점", "본점", "로스터리", "로스터스", "로스터즈", "로스터", "로스팅", "베이커리", "베이크샵", "베이크하우스", "브런치카페", "베이글샵", "도넛", "디저트", "케이크", "케익", "케잌", "케이크샵", "케익샵", "케잌샵", "제과", "제과점", "과자점", "베이킹", "coffee", "cafe", "cake", "roasters", "roaster", "roastery", "roasteries", "책방", "북카페"]);
