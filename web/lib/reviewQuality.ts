...
const NONCAFE_BIZ = /(스시|초밥|칼국수|국밥|설렁탕|곰탕|냉면|삼겹|고깃집|고기집|곱창|막창|횟집|회집|포차|이자카야|타코|부리또|쌀국수|라멘|라면집|우동|소바|규동|텐동|덮밥|분식|떡볶이|김밥집|만두집|돈까스|돈가스|짬뽕|마라탕|족발|보쌈|치킨집|피자집|미용실|헤어샵|헤어룸|네일|속눈썹|왁싱|필라테스|헬스장|피트니스|요가원|치과|한의원|정형외과|이비인후과|피부과|약국|학원|독서실|고시원|펜션|모텔|숙박|부동산|공인중개|정육|마트|세차|에스테틱|피부관리|얼굴관리|바디관리|윤곽관리|웨딩관리|경락|반영구|체형교정|도수치료|태닝|마사지샵|슈가링|제모|두피문신|타투이스트|네일샵|골프연습장|스크린골프|골프존|요양원|요양병원|방문요양|주간보호|납골당|봉안당|추모공원|묘지|수목장|상조|장례식장|인력사무소|직업소개소)/;
// 비카페 '주제' 글(문학·독서·게임·미디어) — 카페 이름이 유명 시/제목/문구('비에도 지지않고'=미야자와 겐지 시)일 때
//   그 시·책·게임 인용 글이 이름 매칭으로 딸려오는 오염 차단. 강한 비카페 주제 마커.
const OFFTOPIC_TOPIC = /(미야자와|겐지|그림책|동화책|독서모임|북클럽|독후감|감상문|시집|소설책|에세이집|문학상|월드컵|올림픽|성배전쟁|붕괴\s*\d|원신|게임\s*(이벤트|공략|패치|리뷰)|콘서트\s*후기|앨범\s*리뷰|컴백|뮤직비디오|드라마\s*리뷰|웹툰|넷플릭스|바람에도\s*지지|폭풍에도\s*지지|더위에도\s*지지|눈에도\s*지지|눈보라에도|뮤지컬\s*(관람|후기|티켓|캐스팅|넘버|커튼콜|공연|무대)|연극\s*(관람|후기|무대|공연)|생생정보|골목식당|수요미식회|맛있는\s*녀석들|공연\s*(소식|일정|예약|취소|관람))/;
// 지역 SEO 서비스 홍보 블로그 — 법률·시공·의료·청소 등 비카페 서비스 SEO 글이 카페명(일상어)을 제목에 끼워 오염(이해·공유·유지…).
const LOCAL_SEO_SERVICES = /(개인회생|채무조정|파산신청|전세사기|보증금반환|명도소송|이혼소송|교통사고\s*변호사|형사전문|법률상담|샤시교체|창호견적|도배시공|입주청소|이사비용|하수구\s*뚫|누수탐지|배관수리|보일러수리|설비업체|임플란트\s*시술|성형수술|도수치료|비수술치료|산후조리|피부관리\s*시술|탈모치료|치아교정|렌탈정수기|법무사|등기대행|세무대리|노무상담|하자보수|줄눈시공|곰팡이제거|에어컨청소|입주\s*청소|상조\s*가입)/;
