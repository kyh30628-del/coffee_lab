...
const NONCAFE_BIZ = /(스시|초밥|칼국수|국밥|설렁탕|곰탕|냉면|삼겹|고깃집|고기집|곱창|막창|횟집|회집|포차|이자카야|타코|부리또|쌀국수|돈까스|돈가스|짬뽕|마라탕|족발|보쌈|치킨집|피자집|미용실|헤어샵|헤어룸|네일|속눈썹|왁싱|필라테스|헬스장|피트니스|요가원|치과|한의원|정형외과|이비인후과|피부과|약국|학원|독서실|고시원|펜션|모텔|숙박|부동산|공인중개|정육|마트|세차)/;
