...
const LOCAL_SEO_SERVICES = /(개인회생|채무조정|파산신청|전세사기|보증금반환|명도소송|이혼소송|교통사고\s*변호사|형사전문|법률상담|샤시교체|창호견적|도배시공|입주청소|이사비용|하수구\s*뚫|누수탐지|배관수리|보일러수리|설비업체|임플란트\s*시술|성형수술|도수치료|비수술치료|산후조리|피부관리\s*시술|탈모치료|치아교정|렌탈정수기)/;
