...
export async function healPublishedAudit(limit = 300, unpubCap = 80): Promise<{ scanned: number; unpublished: number; flagged: number; regression: boolean; names: string[] }> {
  await ensureCols();
