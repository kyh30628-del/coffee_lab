...
export async function healPublishedAudit(limit = 2000, unpubCap = 300): Promise<{ scanned: number; unpublished: number; flagged: number; regression: boolean; names: string[] }> {
  await ensureCols();
