...
- 생두 관세: FTA 체결국 0%/미체결 2%(원산지증명 구비 시, 추정). 부가세 생두 면제. origin_diff.csv의 tariff 열.
- 가정값: CIF 8%(운임5~12%), 물류 250원/kg, 마진 15%, 로스팅손실 17% — 모두 업계 일반범위 추정, 사용자 조정 전제. 정밀화 시 관세청 운송비용 공공데이터(data.go.kr 15129097) 연동 가능.
